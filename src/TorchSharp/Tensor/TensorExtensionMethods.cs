...
namespace TorchSharp
{
    ...
    public static class TensorExtensionMethods
    {
        ...
        /// </param>
        /// <returns></returns>
        public static Tensor print(this Tensor t, string? fltFormat = "g5", int? width = 100, string? newLine = torch.NewLine, CultureInfo? cultureInfo = null, TensorStringStyle style = TensorStringStyle.Default)
        {
